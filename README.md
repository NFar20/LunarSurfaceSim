...
# Usage
Using this program requires the additional download of SPICE kernels and the Diviner temperature data. These files can be found in this [Google Drive folder](https://drive.google.com/drive/folders/1FCagEN8Y4_OmcxCDl7Fshm0vRy1-ySBz?usp=sharing).
